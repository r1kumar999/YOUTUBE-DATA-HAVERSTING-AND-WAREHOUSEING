...
Channels_id=st.text_input('Enter The Channels ID')
...
#SQL CONNECTIONS WITH QUESTIONS AND ANSWERS'S:
...
elif questions== '7. Views Of All Videos':
    query7="""select channel_name as channelname,viewer_count as viwerscount from channels;"""
